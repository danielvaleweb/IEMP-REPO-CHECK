          ...
          <div className="flex items-center gap-4 md:gap-8">
            ...
            {user ? (
              <DropdownMenu>
                <DropdownMenuTrigger
                  render={
                    <button className="flex items-center gap-2 opacity-90 hover:opacity-100 transition-opacity outline-none">
                ...
                <DropdownMenuContent className="w-56 bg-black border-white/10 text-white rounded-xl mt-4 p-2 shadow-2xl" align="end">
                  ...
                  {isAdmin && (
                    <DropdownMenuItem render={<Link to="/admin" />} className="rounded-lg focus:bg-white/10 hover:bg-white/10 focus:!text-white hover:!text-white py-3 px-4 text-primary transition-colors">
              ...
              <button 
                onClick={login} 
                className="text-white/90 hover:text-white transition-all p-2 opacity-90 hover:opacity-100"
                title="Login"
              >
