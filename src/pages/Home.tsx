          ...
          {upcomingEvents.length > 0 && (
            <div className="mb-20">
              ...
              >
                ...
                <div className="absolute top-8 right-8 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-xl flex items-center gap-1.5 shadow-xl">
                  <span className="text-sm font-black text-black">{upcomingEvents[0].rating}</span>
                ...
                <div className="absolute bottom-12 left-12 right-12 max-w-2xl">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="hidden md:flex ml-auto items-center gap-2">
                       ...
                       <span className="text-[10px] font-black text-white/50 uppercase tracking-widest ml-2">Organizadores</span>
                    </div>
                  </div>
                </div>
              </motion.div>
