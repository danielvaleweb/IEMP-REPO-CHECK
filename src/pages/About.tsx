          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {members.map(member => (
              ...
              >
                ...
                <div className="px-6 relative flex justify-between items-start -mt-12 h-16 mb-2">
                  <div className="w-24 h-24 rounded-full border-[4px] border-white bg-white overflow-hidden shadow-sm z-10 relative">
                     <img 
                  ...
                  <div className="pt-14">
                    {isEligibleToChat && profile?.id !== member.id && (
                      <button
                        ...
                        className="h-10 px-6 rounded-full bg-black text-white text-sm font-bold tracking-wide hover:bg-gray-800 transition-colors shadow-sm active:scale-95 z-10"
                      >
                        Mensagem
                      </button>
                    )}
