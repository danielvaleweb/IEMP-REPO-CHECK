  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[20%] left-[20%] w-[40vw] h-[40vw] rounded-full bg-[#BF76FF]/10 blur-[120px]" />
        <div className="absolute bottom-[20%] right-[20%] w-[30vw] h-[30vw] rounded-full bg-blue-500/10 blur-[100px]" />
      </div>

      <div className="relative z-10 w-full max-w-md bg-[#1a1a1a] rounded-[30px] p-8 border border-white/10 shadow-2xl flex flex-col items-center">
        ...
        {authError && (
          <div className="w-full bg-red-500/10 border border-red-500/20 text-red-500 text-sm p-4 rounded-xl mb-6 text-center">
            {authError}
          </div>
        )}
        ...
        <Button 
          ...
          className="w-full h-14 rounded-2xl bg-white text-black font-bold text-lg hover:bg-gray-100 transition-all flex items-center justify-center gap-3"
        >
          {isSubmitting ? (
